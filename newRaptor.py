...
from .newRaptor_dialog import NewRaptorDialog
import os.path
...
class NewRaptor:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&New Raptor')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/newRaptor/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'New raptor'),
            callback=self.run,
